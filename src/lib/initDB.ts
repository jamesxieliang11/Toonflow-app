    ...
    },
    {
      ...
      initData: async (knex) => {
        await knex("t_imageModel").insert([
          ...
          { manufacturer: "qwen", model: "wan2.6-t2i", grid: 0, type: "t2i" },
          { manufacturer: "qwen", model: "wan2.5-t2i-preview", grid: 0, type: "t2i" },
          { manufacturer: "qwen", model: "wan2.2-t2i-flash", grid: 0, type: "t2i" },
          { manufacturer: "qwen", model: "wanx2.1-t2i-turbo", grid: 0, type: "t2i" },
